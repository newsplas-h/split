...
B7=Button(f3, text="Rotate PDF", command=pdfRotateAll, relief=GROOVE, borderwidth=2)
B8=Button(f3, text="Rotate Single Page", command=pdfRotateStart, relief=GROOVE, borderwidth=2)
